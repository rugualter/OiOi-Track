    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('source', models.CharField(choices=[('tmdb', 'The Movie Database'), ('tvdb', 'TheTVDB'), ('mal', 'MyAnimeList'), ('mangaupdates', 'MangaUpdates'), ('igdb', 'Internet Game Database'), ('openlibrary', 'Open Library'), ('hardcover', 'Hardcover'), ('comicvine', 'Comic Vine'), ('bgg', 'BoardGameGeek'), ('manual', 'Manual')], max_length=20)),
                ('provider', models.CharField(choices=[('tmdb', 'The Movie Database')], default='tmdb', max_length=20)),
                ('order_type', models.CharField(choices=[('official', 'Offical'), ('aired', 'Aired'), ('dvd', 'DVD'), ('absolute', 'Absolute'), ('alternate', 'Alternate'), ('alttwo', 'Alternate Variant'), ('regional', 'Regional'), ('digital', 'Digital')], default='official', max_length=20)),
                ('media_type', models.CharField(choices=[('tv', 'TV Show'), ('season', 'TV Season'), ('episode', 'Episode'), ('movie', 'Movie'), ('anime', 'Anime'), ('manga', 'Manga'), ('game', 'Game'), ('book', 'Book'), ('comic', 'Comic'), ('boardgame', 'Boardgame')], default='movie', max_length=10)),
